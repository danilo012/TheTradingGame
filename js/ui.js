...
info.onclick = function() {
  Swal.fire({
    html: '<img src="svgs/menulogo.svg" style="isolation:isolate; width: 50%; cursor: pointer;" viewBox="0 0 512 512" onclick="window.open(\\', \'_blank\')"><br><h1>'+ document.title +'</h1><h5>Version '+ version +'</h5><a href="" target="_blank">Open Source License</a>'
  });
